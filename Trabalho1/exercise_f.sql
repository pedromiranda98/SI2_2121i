USE L51NG7; -- Create the database if it doesn't exist yet
GO
...
--EXEC p_criaInter @ativo_id = 111111111, @estado = 
EXEC p_criaInter @ativo_id = 000000001, @valor = 28.10 , @data_inicio = '2017-11-10', @data_fim = '2017-11-15', @periodicidade = 5, @descricao = 'avaria'
